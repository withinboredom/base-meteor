SellerEnvy.Views.ResetPassword = React.createClass({
  componentDidMount() {
    SellerEnvy.Modules.client.resetPassword( { form: "#reset-password" } );
  },
  handleSubmit( event ) {
    event.submitHandler();
  },
      ...
      <div className="row">
        <div className="col-xs-12 col-sm-6 col-md-4">
          ...
          <form id="reset-password" className="reset-password" onSubmit={this.handleSubmit}>
            <p className="alert alert-info">To reset your password, enter a new one below. You will be logged in
